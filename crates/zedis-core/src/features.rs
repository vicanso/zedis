...
pub enum ServerCommand {
    ...
    ClientKill,
    AclList,
    /// `ACL LOG` — the security-event log behind the ACL page's second tab.
    AclLog,
    AclSetUser,
    FunctionList,
    FunctionLoad,
...
impl ServerCommand {
    ...
    pub const fn word(self) -> &'static str {
        match self {
            ...
            ServerCommand::AclList | ServerCommand::AclLog | ServerCommand::AclSetUser => "ACL",
