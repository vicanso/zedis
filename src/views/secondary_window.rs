...
use gpui::{App, Entity, FocusHandle, Focusable, KeyDownEvent, Window, WindowOptions, div, prelude::*};
...
///
/// The `build` closure receives `(window, cx)` and should return the content
/// entity. The window is automatically wrapped with [`Root`] (required by
/// gpui_component widgets) and [`SecondaryWindow`] (focus + ESC handling).
